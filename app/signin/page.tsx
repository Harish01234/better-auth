...
export default function SigninPage() {
  ...
  const handleEmailSignin = () => {
    ...
    try {
        ...
        const data = authClient.signIn.email({email, password})
  ...
  const handleGithubSignin = () => {
    ...
    try {
        ...
        const data= authClient.signIn.social({provider: "github"})
      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="mt-2 w-full rounded-lg bg-indigo-600 py-2.5 text-sm font-semibold text-white transition hover:bg-indigo-700 active:scale-[0.98]"
          >
            Sign in
          </button>
        </div>
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg border py-2.5 text-sm font-medium transition hover:bg-gray-50 active:scale-[0.98]"
        >
